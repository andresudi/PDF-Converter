...
public class BCAClient {
	...
	public static String stringToSignFormat(String httpMethod, String urlAPI, String accessToken, String payload, String timestamp) {
		
		String shaPayload = Hash.sha256(payload.replaceAll("\\s", ""));
		
		System.out.println("payload replaceAll ===> " + payload.replaceAll("\\s", ""));
		
		String stringToSign = httpMethod + ":" + urlAPI + ":" + accessToken + ":" 
							  + shaPayload.toLowerCase() + ":" + timestamp;
