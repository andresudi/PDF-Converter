...
public class BCAService {
	...
	public Response getBalanceInformation() {
		...
		String relativeUrl = "/banking/v3/corporates/" + BalanceInformation.CorporateID
							 + "/accounts/" + BalanceInformation.AccountNumber;
		...
		String stringToSign = BCAClient.stringToSignFormat("GET", 
															relativeUrl, 
															accessToken, 
															payload.toString(), 
															formatTimeISO);
        ...
        response = target.request()
        				 .headers(headers)
        				 .method("GET", Entity.text(payload.toString()));
	...
	public Response fundTransfer(String inputJson) throws JsonParseException, IOException {
		...
		// Get stringToSign as requirement to get signature
		String stringToSign = BCAClient.stringToSignFormat("POST", 
															relativeUrl, 
															accessToken, 
															payload.toString(), 
															formatTimeISO);
	...
	public Response getInfoVirtualAccountByRequestId() {
		...
		// BCA End point that wants to called, Inquiry by Request Id
		String relativeUrl = "/va/payments?" + "CompanyCode=" + VirtualAccount.CompanyCode
							 + "&" + "RequestID=" + VirtualAccount.RequestID;
		...
		// Get stringToSign as requirement to get signature
		String stringToSign = BCAClient.stringToSignFormat("GET", relativeUrl, 
															accessToken, 
															payload.toString(), 
															formatTimeISO);
	...
	public Response getInfoVirtualAccountByCustomerNumber() {
		...
		// BCA End point that wants to called, Inquiry by Request Id
		String relativeUrl = "/va/payments?" + "CompanyCode=" + VirtualAccount.CompanyCode
							 + "&" + "CustomerNumber=" + VirtualAccount.CustomerNumber;
